...
'''
This is version of using strategy "m"
 __ __
|  |  |
x  x  x

x is tower, line is path strategy
'''
...
def modify_path():
    global cap_dict, path, place_height, pose_dict, via_point_offset, extra_via_point_offset
    ...
    for i in range(L-1):
      ...
      if (auxiliary == "B") and (cur_cap["B"] != 0) and (path[ii][3]=="suck"):
        ...
        heighest = heighest + extra_via_point_offset
