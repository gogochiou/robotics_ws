...
class PublishThread(threading.Thread):
    def __init__(self, rate, tar_device):
        ...
        self.joint1 = J_origin[0]
        self.joint2 = J_origin[1]
        self.joint3 = J_origin[2]
        self.joint4 = J_origin[3]
        self.eff_state = 0.0
    ...
    def update(self, j1, j2, j3, j4, eff_state):
    ...
    def stop(self):
        self.done = True
        self.update(J_origin[0], J_origin[1], J_origin[2], J_origin[3], 0)
        self.join()
    ...
    def run(self):
        ...
        while not self.done:
            ...
            theta_cmd = [self.joint1, self.joint2, self.joint3, self.joint4, self.eff_state]
        ...
        arm_msg = Float64MultiArray(data=[PI/2, 0, -PI/2, 0, 0])
        self.publisher.publish(arm_msg)
...
if __name__=="__main__":
    ...
    try:
        ...
        pub_thread.update(j1, j2, j3, j4, eef_state)
        ...
        while(1):
            ...
            elif key in effBindings.keys():
                eff_state = effBindings[key]
            else:
                # Skip updating output topic if key timeout and robot already
                # stopped.
                if key == '' and j1 == PI/2 and j2 == 0.0 and j3 == -PI/2 and j4 == 0.0 and eef_state == 0.0:
                    continue
                # j1 = 0.0
                # j2 = 0.0
                # j3 = 0.0
            ...
            pub_thread.update(j1, j2, j3, j4, eff_state)
